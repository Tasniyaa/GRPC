...
public final class userGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.yrrhelp.grpc.User.Registration,
      com.yrrhelp.grpc.User.APIResponse> getRegisterMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "register",
      requestType = com.yrrhelp.grpc.User.Registration.class,
      responseType = com.yrrhelp.grpc.User.APIResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yrrhelp.grpc.User.Registration,
      com.yrrhelp.grpc.User.APIResponse> getRegisterMethod() {
    io.grpc.MethodDescriptor<com.yrrhelp.grpc.User.Registration, com.yrrhelp.grpc.User.APIResponse> getRegisterMethod;
    if ((getRegisterMethod = userGrpc.getRegisterMethod) == null) {
      synchronized (userGrpc.class) {
        if ((getRegisterMethod = userGrpc.getRegisterMethod) == null) {
          userGrpc.getRegisterMethod = getRegisterMethod = 
              io.grpc.MethodDescriptor.<com.yrrhelp.grpc.User.Registration, com.yrrhelp.grpc.User.APIResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "user", "register"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yrrhelp.grpc.User.Registration.getDefaultInstance()))
  ...
  public static abstract class userImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void register(com.yrrhelp.grpc.User.Registration request,
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.yrrhelp.grpc.User.Registration,
  ...
  public static final class userBlockingStub extends io.grpc.stub.AbstractStub<userBlockingStub> {
    ...
    /**
     */
    public com.yrrhelp.grpc.User.APIResponse register(com.yrrhelp.grpc.User.Registration request) {
  ...
  public static final class userFutureStub extends io.grpc.stub.AbstractStub<userFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yrrhelp.grpc.User.APIResponse> register(
        com.yrrhelp.grpc.User.Registration request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGISTER:
          serviceImpl.register((com.yrrhelp.grpc.User.Registration) request,
              (io.grpc.stub.StreamObserver<com.yrrhelp.grpc.User.APIResponse>) responseObserver);
          break;
        case METHODID_LOGIN:
